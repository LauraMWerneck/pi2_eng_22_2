...
void Motores::fe(unsigned char velocidade) {
  parar();
  ...
  analogWrite(M1, velocidade);
  analogWrite(M2N, velocidade*0.25);



}
void Motores::fd(unsigned char velocidade) {
  parar();


  velocidade &= 0xff;

  analogWrite(M1N, velocidade*0.25);
  analogWrite(M2, velocidade);



}
void Motores::te(unsigned char velocidade) {
  parar();
  ...
  analogWrite(M1N, velocidade);
  analogWrite(M2, velocidade*0.25);
}
void Motores::td(unsigned char velocidade) {
  parar();
  ...
  analogWrite(M1, velocidade*0.25);
  analogWrite(M2N, velocidade);
}